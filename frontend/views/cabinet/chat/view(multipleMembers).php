                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-3">
                                        <div class="image-block">
                                            <img src="<?php echo $project_chat->project->logo;?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-xs-9">
                                        <b><?=$project_chat->project->name;?></b> <i class="icon new">fiber_new</i>
                                    </div>
                                </div>
                            </li>
            ...
            <div id="test">
                <?php if(!empty($model)){?>
                    <div class="messages" id="messages">
                        <div class="title"><b>Проект:</b> <?=$model->project->name?></div>
                        <div class="content">
                            <div class="people">
                                <span>Участники чата</span>
                                <?php foreach($model->members as $member){?>
                                    <a href="#"><img src="<?=$member->getAvatar()?>" alt="<?php if($member->isModel()){echo $member->model->first_name;}elseif($member->isClient()){echo $member->client->contact_face;}?>"></a>
                                <?php } ?>
                            </div>
